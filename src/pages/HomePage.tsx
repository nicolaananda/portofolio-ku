...
import { ArrowRight, ArrowUpRight, Code, Database, Layout, Smartphone, Globe, Cpu, BarChart3, Activity, Github, Linkedin, Mail, AlertCircle } from 'lucide-react';
import SEOHead from '../components/SEOHead';
import AnimatedSection from '../components/AnimatedSection';
import useProjects from '../hooks/useProjects';

const HomePage = () => {
  const { projects: featuredProjects, isLoading, error } = useProjects({ limit: 4 });
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        ...
                        <div className="w-12 h-12 rounded-xl bg-gray-50 dark:bg-gray-800 border border-black/5 dark:border-white/5 flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform duration-300">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              if (parent) {
                                parent.innerHTML = `<span class="text-xs font-bold text-gray-500">${tech[0]}</span>`;
                              }
                            }}
                          />
                        </div>
                        <span className="text-[10px] font-medium text-gray-400">{tech}</span>
                      </div>
                    );
                  })}
                </div>
            ...
            <div className="col-span-1 glass-panel p-8 rounded-[2.5rem] flex flex-col justify-center animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex gap-4">
                ...
                <a href="mailto:hello@nicola.id" className="w-12 h-12 rounded-full bg-red-500 text-white flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
      ...
      <AnimatedSection className="py-20 px-4">
        <div className="container max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12">
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter">Selected Work</h2>
          ...
          {error && (
            <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
              ...
              <p className="text-lg font-semibold text-gray-700 dark:text-gray-300">Gagal memuat proyek</p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {isLoading ? (
                ...
                featuredProjects.map((project) => (
                  <Link
                    to={`/portfolio/${project.slug || project._id || project.id}`}
                  ...
                  >
                    ...
                    <div className="px-2">
                      <div className="flex justify-between items-start">
                        <div>
                          <div className="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider">{project.category}</div>
        ...
        <div className="container max-w-5xl mx-auto">
          <div className="glass-panel rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6">Ready to collaborate?</h2>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Button asChild variant="outline" size="lg" className="rounded-full h-14 px-10 text-lg font-bold border-2 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                  <a href="mailto:hello@nicola.id">hello@nicola.id</a>
                </Button>
              </div>
            </div>
          </div>
